...
<div class="admin-wrap">
  ...
  <p><a class="btn" href="zone_form.php">+ เพิ่มโซน</a></p>
  ...
  <div class="table-scroll">
    <table>
      <thead>
        <tr><th>รหัส</th><th>ชื่อ</th><th>จำนวนต้นไม้</th><th>ความครบถ้วนข้อมูล</th><th></th></tr>
      </thead>
      <tbody>
        ...
        <?php endforeach; ?>
        <?php if (!$zones): ?>
        <tr><td colspan="5">ยังไม่มีโซน</td></tr>
        <?php endif; ?>
      </tbody>
    </table>
  </div>
