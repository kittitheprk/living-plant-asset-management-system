...
<div class="admin-wrap">
  ...
  <div class="table-scroll">
    <table>
      <thead>
        <tr><th>ลำดับ</th><th>Tree ID</th><th>รหัสต้นไม้ (15 หลัก)</th><th>ชนิดพันธุ์</th><th>โซน</th><th>ป้ายชื่อ</th><th>สถานะ</th><th>เปิดใช้งาน</th><th>URL สาธารณะ</th><th></th></tr>
      </thead>
      <tbody>
        ...
        <?php endforeach; ?>
        <?php if (!$trees): ?>
        <tr><td colspan="10">ไม่พบต้นไม้</td></tr>
        <?php endif; ?>
      </tbody>
    </table>
  </div>
